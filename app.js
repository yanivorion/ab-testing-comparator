...
const TEST_WEBSITES_ALGORITHM_DEFAULT = [
  ...
  { id: 'pm-resume', name: 'PM Resume', url: 'https://davidso95.wixsite.com/pm-resume-algo' },
  { id: 'umbaui', name: 'Umbaui', url: 'https://galbu09.wixsite.com/umbaui-algo' },
  { id: 'fitness-studio', name: 'Fitness Studio', url: 'https://nivz30.wixsite.com/fitness-studio-algo' },
  { id: 'wedding-invitation', name: 'Wedding Invitation', url: 'https://nivz30.wixsite.com/weddinginvitatioalgo' },
  { id: 'dahlia-curtis', name: 'Dahlia Curtis', url: 'https://galbu09.wixsite.com/dahliacurtis-algo' },
  { id: 'classic-showcase', name: 'Classic Showcase', url: 'https://galbu09.wixsite.com/classicshowcase-algo' },
  { id: 'emonroe', name: 'E Monroe', url: 'https://galbu09.wixsite.com/emonroe-algoo' },
  { id: 'margaret-vale', name: 'Margaret Vale', url: 'https://galbu09.wixsite.com/margaretvale-algo' },
  { id: 'hoyjob', name: 'Hoyjob', url: 'https://galbu09.wixsite.com/hoyjob-algo' },
  { id: 'fashion-store', name: 'Fashion Store', url: 'https://nivz30.wixsite.com/fashion-store-algo' },
  { id: 'marbam', name: 'Marbam', url: 'https://galbu09.wixsite.com/marbam-algo' },
  { id: 'family-clinic', name: 'Family Clinic', url: 'https://galbu09.wixsite.com/familyclinic-algo' },
  { id: 'construction', name: 'Construction', url: 'https://davidso95.wixsite.com/contruction-algo' },
  { id: 'create-cv', name: 'Create CV', url: 'https://davidso95.wixsite.com/creat-cv-algo' },
  { id: 'business-consult', name: 'Business Consulting', url: 'https://davidso95.wixsite.com/busi-consult-algo' },
  { id: 'bakery-warm', name: 'Bakery Warm', url: 'https://davidso95.wixsite.com/bakery-warm-algo' },
  { id: 'nadine-hich', name: 'Nadine Hich', url: 'https://davidso95.wixsite.com/nadine-hich-algo' },
  { id: 'modern-layout', name: 'Modern Layout', url: 'https://galbu09.wixsite.com/modernlayout-algo' },
  { id: 'erice', name: 'Erice', url: 'https://yanivo4.wixsite.com/erice-algo' },
  { id: 'manuela-sacuni', name: 'Manuela Sacuni', url: 'https://yanivo4.wixsite.com/manuela-sacuni-algo' },
  { id: 'sanders-young', name: 'Sanders & Young', url: 'https://yanivo4.wixsite.com/sandersandyoung-algo' },
  { id: 'jauter', name: 'Jauter', url: 'https://yanivo4.wixsite.com/jauter-algo' },
  { id: 'james-j-dee', name: 'James J. Dee', url: 'https://yanivo4.wixsite.com/james-j-dee---algo' }
];
...
const TEST_WEBSITES_DESIGNER_DEFAULT = [
  ...
  { id: 'site-238', name: 'My Site 238', url: 'https://galbu09.wixsite.com/my-site-238' },
  { id: 'ux-designer-sleek-designer', name: 'UX Designer Sleek', url: 'https://nivz30.wixsite.com/ux-designer-sleek' },
  { id: 'aijalo-designer', name: 'Aijalo', url: 'https://davidso95.wixsite.com/aijalo' },
  { id: 'toulouse-designer', name: 'Toulouse', url: 'https://galbu09.wixsite.com/toulouse' },
  { id: 'pm-resume-designer', name: 'PM Resume', url: 'https://davidso95.wixsite.com/pm-resume' },
  { id: 'umbaui-designer', name: 'Umbaui', url: 'https://galbu09.wixsite.com/umbaui' },
  { id: 'fitness-studio-bold', name: 'Fitness Studio Bold', url: 'https://nivz30.wixsite.com/fitness-studio-bold' },
  { id: 'wedding-invitation-designer', name: 'Wedding Invitation', url: 'https://nivz30.wixsite.com/wedding-invitation' },
  { id: 'dahlia-curtis-designer', name: 'Dahlia Curtis', url: 'https://galbu09.wixsite.com/dahliacurtis' },
  { id: 'classic-showcase-designer', name: 'Classic Showcase', url: 'https://galbu09.wixsite.com/classicshowcase' },
  { id: 'emonroe-designer', name: 'E Monroe', url: 'https://galbu09.wixsite.com/emonroe' },
  { id: 'margaret-vale-designer', name: 'Margaret Vale', url: 'https://galbu09.wixsite.com/margaretvale' },
  { id: 'hoyjob-designer', name: 'Hoyjob', url: 'https://galbu09.wixsite.com/hoyjob' },
  { id: 'fashion-store-clean', name: 'Fashion Store Clean', url: 'https://nivz30.wixsite.com/fashion-store-clean' },
  { id: 'marbam-designer', name: 'Marbam', url: 'https://galbu09.wixsite.com/marbam' },
  { id: 'family-clinic-designer', name: 'Family Clinic', url: 'https://galbu09.wixsite.com/familyclinic' },
  { id: 'construction-designer', name: 'Construction', url: 'https://davidso95.wixsite.com/contstruction' },
  { id: 'create-cv-designer', name: 'Create CV', url: 'https://davidso95.wixsite.com/creat-cv' },
  { id: 'business-consulting-designer', name: 'Business Consulting', url: 'https://davidso95.wixsite.com/business-consulting' },
  { id: 'bakery-warm-designer', name: 'Bakery Warm', url: 'https://davidso95.wixsite.com/bakery-warm' },
  { id: 'nadine-hoch', name: 'Nadine Hoch', url: 'https://davidso95.wixsite.com/nadine-hoch' },
  { id: 'modern-layout-designer', name: 'Modern Layout', url: 'https://galbu09.wixsite.com/modernlayout' },
  { id: 'erice-designer', name: 'Erice', url: 'https://yanivo4.wixsite.com/erice' },
  { id: 'manuela-sacuni2', name: 'Manuela Sacuni', url: 'https://yanivo4.wixsite.com/manuela-sacuni2' },
  { id: 'sanders-young-designer', name: 'Sanders & Young', url: 'https://yanivo4.wixsite.com/sandersandyoung' },
  { id: 'jauter-designer', name: 'Jauter', url: 'https://yanivo4.wixsite.com/jauter' },
  { id: 'james-j-dee-designer', name: 'James J. Dee', url: 'https://yanivo4.wixsite.com/james-j-dee' }
];
